...
export default function SettingsPage() {
  ...
  return (
    <div className="analytics-shell">
      <PageHeader
        eyebrow="Settings"
        title="控制主题、刷新策略和本地数据边界。"
        description="这套面板默认以本地优先方式运行：你可以切换主题、导入导出配置，并且清楚知道哪些数据被保留、哪些不会导出。"
        stats={[
          { label: '主题', value: settings.theme === 'dark' ? '深色' : '浅色', detail: '双主题统一风格' },
          { label: '刷新间隔', value: `${settings.refreshInterval}s`, detail: '建议保持在 60–300 秒' },
        ]}
      />
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
        <Card>
          <CardHeader>
            ...
            <CardTitle className="mt-2 text-base">基础设置</CardTitle>
          </CardHeader>
        ...
        <div className="space-y-5">
          <Card>
            <CardHeader>
              ...
              <CardTitle className="mt-2 text-base">数据管理</CardTitle>
            </CardHeader>
            <CardContent className="space-y-5">
              <SettingRow
                label="导出数据"
          ...
          <Card className="opacity-80">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Badge variant="outline" className="rounded-full text-xs">即将支持</Badge>
            </CardHeader>
            <CardContent>
